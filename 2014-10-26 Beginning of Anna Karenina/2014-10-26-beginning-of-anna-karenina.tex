...
\tsup{6b}~Ang saroyye envan sangalas yena, ang manga yomoyya ayon rangya ton 
    luga bahisya kay.
\tsup{7}~Sa senyon ganye nangaya-hen, …
...
For this passage as well, a few new words had to be coined: \ayr{senF/} 
\fw{sen-} \qq{neglect}, …
