...
ANF mN yomojy AyonF rNY tonF lug bhisY kj. - - - 
\end{ayeri}
...
sangalas yena, ang manga yomoyya ayon rangya ton luga bahisya kay.
...
\begin{exe}
	...
	\mor{3SG.F.GEN}, … \\
    \glt \enquote{The wife did not leave her room, …}
	
    \ex \gll …, ang manga yoma -oy -ya ayon {} rang -ya ton luga bahis -ya kay. \\
    …, \mor{AT} \mor{PROG} exist \mor{-NEG} \mor{-3SG.M} husband \mor{(.T)} home 
	\mor{-LOC} \mor{3PL.N.GEN} for day \mor{-LOC} three. \\
    \glt \enquote{…, the husband had not been at home for three days.}
    \end{xlist}
\end{exe}
...
\fw{yanoyam} \qq{because}, since either reading is possible. This sentence is
also a good illustration for Ayeri's sparsity with tense marking: the (past) 
perfect sense of Oblonsky not having been \textcquote{tolstoy}{at home for 
three days} prior to the time of narration is only conveyed by the time 
adverbial, \q{manga … luga bahisya kay}.
