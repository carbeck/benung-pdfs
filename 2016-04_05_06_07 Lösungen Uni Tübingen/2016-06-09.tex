...
\begin{itemize}
	\item Wortstämme: Wörterbucheinträge zu `boat', `glide', `my', `full',
		`fill' \parencite{benung};
	\item Satzstellung: \cite[27]{becker2011}, 
		\cite[§~2.1]{benung:flickingswitches};
...
Ein Phrasenstrukturbaum für (\ref{ex:predicative}) könnte vielleicht 
folgendermaßen aussehen, ohne dabei allzu sehr ins Detail (und in favorisierte 
Syntaxtheorien) zu gehen; daneben außerdem ein Dependenzbaum:
