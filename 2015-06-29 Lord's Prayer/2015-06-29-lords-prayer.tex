...
original translation of the \tit{Lord's Prayer}, so the text in Ayeri can be 
presented here in its native script.
...
\begingl
    ...
    \glft `Give us today our daily bread' //
\endgl
\xe
...
\begingl
    ...
    \glft `And forgive us our failures' //
\endgl
\xe
...
\begingl
    ...
    \glft `But from the evil save us' //
\endgl
\xe
