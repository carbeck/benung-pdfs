...
\a \begingl
	...
	\glft `Harder and harder did he blow, and the traveller so wrapped his cloak tighter and tighter.' //
\endgl

\a \begingl
	\glpreamble Subryo ang Pintemis panganya. //
	\gla Subr @ -yo ang= Pintemis pangan @ -ya. //
	\glb give.up -\Tsg{}.\N{} \Aarg{}= {North Wind} end -\Loc{}. //
	\glft `The North Wind gave up in the end.' //
\endgl
\xe

There is an article on my blog that deals with correlative conjunctions \autocite{becker2012}, but unfortunately, that leaves out a discussion of strategies to deal with `as ... as ...' and `the ... the ...'. I racked my brain for a while and came to the conclusion that I could as well paraphrase the respective passages.\footnote{Searching the internet for \enquote{correlative conjunctions} or variations of it proved pretty useless, by the way. Almost only exercise sheets for English classes came up, but nothing that looked like typology papers discussing it.} I suppose that it could be possible to shoehorn the `blew as hard as he could' part into a construction using \xayr{km/}{kama-}{be alike, be as … as …}, but I was feeling a little uneasy about something like:
...
\begingl
	...
	\glft `The North Wind blew as strongly as he could ...' //
\endgl
\xe
