...
marker, as when addressing people. Besides, this would have increased the
...
Mary and Joseph in intimate togetherness with their newborn, Jesus.
...
reciprocity (which colloquial German, for one, also does).
...
Verses four to six now also introduces the main figure of the nativity scene,
the baby in the manger, Jesus Christ. The boy having curly hair is poetic
license, I suppose.
...
the repeated verse 5 and 6. Alternatively, one might choose the
...
translated this more or less literally.
...
The text in \cref{ex:ln09} actually already begins in verse 9, creating an
enjambment because it was convenient given the syllable count. What is
unfortunately lost is the logical correlation to the previous two verses
implied by \fw{da} \wdef{as} in German, also due to meeting the syllable count.

Furthermore, I chose to use \xayr{yesu}{Yesu}{Jesus} here instead of trying to
adapt \fw{Christ} in some way---whether borrowing it as \rayr{kFrisFto}{Kristo}
or \rayr{kFrisF}{Kris} or attempting to loan-translate Greek \fw{Khrīstós}
\wdef{the anointed one}. The stress pattern dictated by the melody (    
  ) goes completely counter to the natural pattern of \rayr{pidimF mdaanen
nn}{pidim madānena nana} (       ).

% - THIRD STANZA --------------------------------------------------------------

\subsection{Third stanza}

The third stanza is the most challenging yet because in German, \fw{durch der
Engel Halleluja} \wdef{per the angles' hallelujah} (v.~15) can be read as
referring to both the previous and the next line. Moreover, a rather literal
...
Instead of the shepherds being announced to as in the German \fw{Hirten erst
kundgemacht} \wdef{first announced to shepherds}, in \cref{ex:ln14}, I
rephrased the text rather neutrally as the shepherds hearing the angels'
jubilation. Anyone familiar with the story will know the context anyway, so I
only slightly regretted also dropping \fw{first} for exceeding the syllable
count. I suppose \xayr{mennFy}{menanya}{one-\Nmlz-\Loc}, literally \wdef{at
first}, could be a viable translation due to the peculiarity of how ordinals
are formed in Ayeri as nouns. The corresponding dative form,
...
\fw{angel}, literally as \rayr{niny}{ninaya} would have yielded the rather
tongue-twisty form \rayr{ninyyen}{ninayayena} in Ayeri's iotaphile fashion. It
would also have been too long. Thus, I decided to extend the meaning of
...
\ex \label{ex:ln16}
	\gll Edauyi tangnang baho naynay:\\
		now hear=\Fpl.\Aarg{} loudly as\_well \\
...
\xayr{ynenF}{yanen}{everywhere} seemed comparably more awkward to me.\bigskip

Now off to grab chords to the song and practice playing and singing it, and
maybe have a recording ready by this year's Christmas.
