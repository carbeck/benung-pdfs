...
% nsYoNojy depaaNF/nm.\\
% maaj s laMtFvaaNF Aj!\\
% saa til—\\
% —yNF niv\\
% vn dimjyeymF.			\tab \textit{kunNFreNF}\\
% y nsYyNF vaasF lito		\tab \textit{kunNFreNF}\\
...
as modifiers to that. So, I decided to keep the lines in \cref{ex:1a} for the
...
below, though I still had to reach into my box of tricks that is contracting
\rayr{depNNF}{depangang} to \xayr{depaaNF}{depāng}{fool}. This also eschews
the awkwardness of \rayr{/ANNF}{-angang} with regard to the corresponding
English line's rhythm.

\begin{exe}
\ex \label{ex:2a}
	\gll Nasyongoyya depāng-nama.\normalfont\footnotemark{} \\
		follow-\Irr-\Neg-\Tsg.\M{} fool-\Aarg=only \\
...
affective \rayr{maaj}{māy} at the start. At first, I tried \xayr{y nsYFyNF
ItiNF vn}{ya nasyyang iting vana}{your path, I'm following it}, which is still
closer to the English text, but was longer by one syllable and thus didn't fit
the melody as well. The rephrased line also lacks a mention of following,
though this motif is at least alluded to by using \xayr{lMt/}{lant-}{lead},
and still explicitly mentioned in \cref{ex:2d}.

\begin{exe}
\ex \label{ex:2b}
	\gll Māy sa lantvāng ay! \\
		\Aff{} \PatT= lead=\Second.\Aarg{} \Fsg.\Top{} \\
	\trans `Oh how I'm led by you!' \\
\end{exe}
