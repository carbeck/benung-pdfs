...
infatuation. The translation follows the English text closely, though Ayeri has
no way to mark an action as involving a punctual change of state in the same
way English uses \fw{fall off} as opposed to just \fw{fall}. Moreover, I
...
line. The number of syllables in the Ayeri text is one more per clause compared
to the English one: 6~+~5 as opposed to 7~+~6 in Ayeri. The overall stress
pattern is similar enough that it works, though. The expression \rayr{suNF–
mimaanlej}{find the opportunity} strikes me as rather Germanic-influenced, but
offhand, I couldn't think of phrasing it differently and still fitting the
music.
