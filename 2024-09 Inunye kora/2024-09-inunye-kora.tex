...
the title, \textquote{Weird fishes}. As the sentence \cref{ex:3} shows,
extensive rephrasing was necessary here compared to the English text,
...
leeway with regards to line length, the challenge was in finding alternate ways
...
%
	...
	score}, a tongue-in-cheek coinage in relation to making up a single word
	including /uː/ for the purpose of having one at all
