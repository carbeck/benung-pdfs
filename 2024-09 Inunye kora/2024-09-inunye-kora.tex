...
mvyen — \textit{tiMkaanFreNF}\\
lesyNF\\
ANF sgonFy maaj EnFy — \textit{tiMkaanFreNF}\\
...
\ex \begin{xlist}
	\ex \label{ex:2a}
		\gll Nasyongoyya depangang-nama. \\
	...
	\ex \label{ex:2d}
		\gll Ya nasyyang vās lito mavayena, lesayang. \\
			\LocT= follow-\Fsg.\Aarg{} \Second.\Parg{} edge-\Top{} world-\Gen{}
			fall=\Fsg.\Aarg{} \\
		\trans `To the edge of the world is where I'll follow you, and fall.'

	\ex \label{ex:2e}
		\gll Ang sagonya māy enya, ang sungya mimānley. \\
			\AgtT= quit-\Tsg.\M{} \Ints{} everyone-\Top{} \AgtT= find-\Tsg.\M{}
