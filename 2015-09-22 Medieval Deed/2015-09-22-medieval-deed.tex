...
\date{2015/10/18 (rev. 3, 2016/08/24)} % Format: YYYY/MM/DD (rev. N, YYYY/MM/DD)
...
@mvcollection{CAO,
	...
	location = {Lahr/Schwarz\-wald and Berlin},
	year = {1932--2004},
}
...
@collection{CAO5,
	booktitle = {{Nachtrags\-urkunden 1261--1297}},
...
@book{demske2001,
	...
	location = {Berlin and New York, NY},
...
\citeauthor{CAO}'s \citetitle*{CAO} (\enquote*{Corpus of Old German Original 
...
\begin{quotation}
\textbf{J}nn\emph{omin}e d\emph{omi}n\emph{i} 
...
\citetitle{CAO} begin, with some variations. Since it's always fun to look up 
...
the headwords in \citeauthor{lexer} and are indicated by ⸢…⸣ brackets when 
...
translation of the deed above as well for the same reason. 
...
\ex \begingl
	\glpreamble Adareng tono, ang saraya Sikontendo Biratayati tiga adaya 
		pesan nay ang no vehya lahanley miday eda-mondo. //
...
\ex[exno=\ref{ex:11}.1] \begingl
	...
	\glb with [ [ the.\Gen{} city \emph{t}\fakesubscript{i} ] seal ] [ to Augsburg ]\fakesubscript{i} //
\endgl \xe
...
\begin{quotation}
	\begin{ayeri}
		...
		AdreNF tono, ANF sry sikoMteMdo birtyti tig Ady pesnF nj ANF no 
			vehFy lhnlej midj Ed/moMdo. %3
		...
		\& ANF beNYnF Ed/mMdnY AyonYe tig ledjynF, bjsikaanF IkMdesj, 
			...
			sik\_o\_MteMdo piku \& kejnmF/IknF pluNF. %12
...
\begin{quotation}
	...
	Adareng tono, ang saraya Sikontendo Biratayati tiga adaya pesan nay ang 
		no vehya lahanley miday eda-mondo. %3
	...
	Nay ang bengyan eda-mandanya ayonye tiga Ledayyan, Baysikān Ikandesay, 
		...
		Sikontendo Intamarkan, Sikontendo Piku nay keynam-ikan palung. %12
...
% than coming up with idiomatic translations 
% of the sentences.
