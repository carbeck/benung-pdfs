...
As a little twist, however, articles go into the so-called \fw{Wackernagel position}, 
...
There would, however, be an exception for possessive phrases, in which the word 
order \textsc{det}\fakesubscript{i}~\textsc{n}~\_\fakesubscript{i}~\emph{of} 
