...
more interesting, though, is that the second half of the \Mhg{} sentence reads
literally as:

\ex[exno=\ref{ex:deslaugent}′]
\begingl
	\glpreamble \rightcomment{[Middle High German]} … daz er mit im alſo 
		iht kauft hete. //
	\gla …~daz er mit im alſo iht kauft hete. //
	\glb …~that he with him so not bought had. //
	\glft \enquote{…~that he had not bought with him this way.} //
\endgl \xe

\fw{Buy with someone} `conclude a sale with someone' is an idiomatic expression 
which I haven't heard that way neither in modern German nor in English so far.
