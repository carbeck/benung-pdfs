...
\ex \begingl
	\glpreamble Maritapya tagātiang, hakaya ang Biratayati, rī intoyyāng
		da-dileng, nārya ang ming pukatongya Hasanjan tiga puluyley 
		yayam. //
	\gla maritap @ -ya tagāti @ -ang, haka @ -ya ang= @ Biratayati, rī
		int @ -oy @ -yāng eda= @ dileng, nārya bata ang ming pukat @ 
		-ong @ -ya Ø= Hasanjan tiga puluy @ -ley yayam. //
	\glb determine -\Tsg{}.\M{} judge -\Aarg{}, testify -\Tsg{}.\M{}
		\Aarg{}= {der Hafener}, \InsT{} buy -\Neg{} -\Tsg{}.\M{}.\Aarg{} 
		such= rule.\Top{}, except if \AgtT{} can prove -\Irr{} 
		-\Tsg{}.\M{} \Top{} Ulrich honorable opposite -\Parg{}.\Inan{} 
		\Tsg{}.\M{}.\Dat{}. //
	\glft \enquote{The judge determined that der Hafener had testified that 
		he had not bought under such a condition, except if the 
		honorable Ulrich could prove the opposite to him.} //
\endgl \xe
...
\ex \begingl
	\glpreamble Le no da-subroyya ang Hasanjan tiga kaytan yana nay 
		le pinyaya bahisyam siyā ming ha\-kong\-yāng.//
	...
	\glb \PatT{} want thus= give.up -\Neg{} -\Tsg{}.\M{} \Aarg{}= Ulrich 
		honorable right.\Top{} \Tsg{}.\Gen{} and \AgtT{} ask 
...
\blockquote{
	...
	\begin{ayeri}
		\fw{AAsFti/nF n paagF ko stJ\_F, AAmenF!} %1
			...
			koNF Ed/moMdo mesmF lhnFlej soyNF nNaasF soyNF vehnFlej 
		...
		tdjy si keNY ANF hsMdYnF tig, ANF shy tgaatiy \& s tirjyaaNF 
			...
			ynoymF ANF tonisy nraaneri bnF yn, ANF vehoyoNY Ady 
			lhnFlej soyNF nNaasF soyNF vehnFlej pluNF silej ENF miNF 
			nupisoNr yaasF. %4
		le grikY ANF birtyti AdnY, nryaaNF, rii IMtojyaaNF d/dileNF. %5
		mritpY tgaati\_aNF, hky ANF birtyti, rii IMtojyaaNF d/dilenF,
			naarY ANF miNF puktoNY hsMdYnF tig pulujlej yym. %6
		le no d/subFrojy ANF hsMdYnF tig kjtnF yn \& ANF pinYy bhisYmF 
...
And for completeness' sake, this is the complete text again in Latin 
transcription:

\blockquote{
	\fw{\textbf{Ā}sti-n na Pāg ko saț, āmen!}\footnote{Alternatively:
		\ayr{graaneri n nhNF, AAmenF!} \fw{Garāneri na Nahang, āmen!}
		See the annotations to example (\ref{ex:innomine}), page 
		\pageref{ex:innomine} for details.} %1
	...
	Maritapya tagātiang, hakaya ang Biratayati, rī intoyyāng da-dileng, 
		nārya ang ming pukatongya Hasanjan tiga puluyley yayam. %6
	Le no da-subroyya ang Hasanjan tiga kaytan yana nay ang pinyaya 
