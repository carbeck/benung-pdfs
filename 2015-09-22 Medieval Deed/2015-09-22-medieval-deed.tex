...
\begin{tabu} to \textwidth {X[40] X[60] X[40] X[60]}
	...
	% FIXME: Look into an actual name dictionary, not Wikipedia or behindthename.com!
...
both German and English here, leaving out something like \norm{ze der zît} or 
...
I translated \norm{clagen} `sue' as \xayr{tirj/}{tiray-}{complain, bemoan} here 
since I thought that this fits the general situation and action -- maybe also 
since the German word \fw{klagen} covers both meanings, `complain' and `sue'.
What is interesting here, though, is that the verb \ayr{tirj/} \fw{tiray-} takes 
a direct object/patient \Np{} as an argument, not a \Pp{}, which is why I gave 
the translation in the gloss as `complain about'.
